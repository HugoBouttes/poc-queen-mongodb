...
export const options = {
  stages: [
  { duration: "20m", target: `${__ENV.VUS}` }, // simulate ramp-up of traffic from 0 to 650 users over 20 minutes.
  { duration: "60m", target: `${__ENV.VUS}` }, // stay at 650 users for 60m minutes
